...
public class Penjualan extends javax.swing.JFrame {
    ...
    public void Kosong(){
    txtIDJual.setEditable(true);
    txtIDJual.setText(null);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(530, 30, 480, 70);
        ...
        txtIDJual.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        txtIDJual.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtIDJualActionPerformed(evt);
            }
        });
        jPanel1.add(txtIDJual);
        txtIDJual.setBounds(200, 110, 140, 23);
        ...
        cbIDBarang.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BG-1", "BG-2", "BG-3", "BG-4" }));
        jPanel1.add(cbIDBarang);
        cbIDBarang.setBounds(200, 150, 140, 20);

        cbIDSup.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SU-31", "SU-32", "SU-33", " ", " " }));
        jPanel1.add(cbIDSup);
    ...
    private void btUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btUbahActionPerformed
        try{
            String sql="UPDATE jual SET kode_jual='"+txtIDJual.getText()+"',"
                    +"kode_barang='"+cbIDBarang.getSelectedItem()+"',"
                    +"kode_supplier='"+cbIDSup.getSelectedItem()+"',"
                    +"tgl_jual='"+txtTglJual.getText()+"',"
                    +"jml_jual='"+txtJumJual.getText()+"',"
                    +"harga_jual='"+txtHargaJual.getText()+"' WHERE kode_jual='"+txtIDJual.getText()+"'";
    ...
    private void btHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btHapusActionPerformed
        try{
            String sql="DELETE FROM jual WHERE kode_jual='"+txtIDJual.getText()+"'";
    ...
    private void btTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btTambahActionPerformed
        try{
            String sql="INSERT INTO jual VALUES('"+txtIDJual.getText()+"',"
    ...
    private void btCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCetakActionPerformed
        try{
            InputStream is = Pembelian.class.getResourceAsStream("/cetak/Penjualan.jasper");
